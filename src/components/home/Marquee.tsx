...
const ReviewCard = ({
	...
	return (
		<figure
			className={cn(
				"group/card relative cursor-pointer overflow-hidden rounded-xl p-[20px] w-[300px] h-[160px] flex flex-col justify-between",
				// light styles
				"rounded-[16px] bg-[#161F15] border-[#161F15] hover:bg-conic-gradient",
				// dark styles
